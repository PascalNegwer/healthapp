<template>
    <div class="l_wrapper l_wrapper--small">
        <div class='impressum'>
            <h1 class="headline headline--h1">Impressum</h1>
            <br>
            <p class="paragraph">
                Angaben gemäß § 5 TMG
            <br><br>
                Hinweis: Diese App ist ein Studienprojekt und nicht für den öffentlichen Gebrauch bestimmt! <br><br>
            DHBW Mosbach <br>
                Oberer Mühlenweg 2-6<br>
                74821 Mosbach<br>
                <br></p>
            <h4 class="paragraph paragraph--strong">Verantwortlich für den Inhalt: </h4>
            <p class="paragraph">
            Miriam Andriof<br>
            Linda Jansen<br>
            Philipp Kuhn<br>
            ...
            Lea-Sophie Rother</p>
            <br>
            <h4 class="paragraph paragraph--strong">Kontakt:</h4>
            <p class="paragraph"> E-Mail: <a href='mailto:wt5health@gmail.com'>wt5health@gmail.com</a>
            </p>
            <br>
            <br>
            <h3 class="headline headline--h3">Haftung für Inhalte</h3>
            <br>
